...
var UserSchema = new _mongoose.Schema({
  ...
  salt: String,
  rooms: [{ type: _mongoose.Schema.Types.ObjectId, ref: 'Room' }],
  request: [{ type: _mongoose.Schema.Types.ObjectId, ref: 'User' }],
  pending: [{ type: _mongoose.Schema.Types.ObjectId, ref: 'User' }],
  spam: [{ type: _mongoose.Schema.Types.ObjectId, ref: 'User' }],
  facebook: {},
  twitter: {},
  github: {}
});
